...
<div style="display: flex; gap: 0.5rem; margin-block: 1rem;">
  <img src="./screenshots/desktop-dark-1.png" alt="Tablet screenshot" width="300" />
  <img src="./screenshots/desktop-dark-2.png" alt="Tablet screenshot" width="300" />
</div>

2. Desktop Light mode:
<div style="display: flex; gap: 0.5rem; margin-block: 1rem;">
  <img src="./screenshots/desktop-light-1.png" alt="Tablet screenshot" width="300" />
  <img src="./screenshots/desktop-light-2.png" alt="Tablet screenshot" width="300" />
</div>

3. Tablet Dark (hover + expanded letter density):
<div style="display: flex; gap: 0.5rem; margin-block: 1rem;">
  <img src="./screenshots/tablet-hover.png" alt="Tablet screenshot" width="290" />
  <img src="./screenshots/tablet-see-more.png" alt="Tablet screenshot" width="290" />
</div>

4. Mobile Light (limit exceed + with and without exclude spaces):
<div style="display: flex; gap: 0.5rem; margin-block: 1rem;">
  <img src="./screenshots/mobile-light-limit.png" alt="Mobile screenshot" width="240"/>
  <img src="./screenshots/mobile-light-spaces.png" alt="Mobile screenshot" width="240"/>
</div>
